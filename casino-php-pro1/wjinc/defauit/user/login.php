...
<style>
.nextbtn {
    background-image: url('http://pic.msgyc.com/index/loginnextbtn.png');
            ...
            <div class="loginform">
				...
				<form action="/index.php/user/logined" method="post" onajax="userBeforeLogin" enter="true" call="userLogin" target="ajax">
                 ...
                 <div class="loginformright">
					...
					点击下载:&nbsp&nbsp<a href="http://dlsw.baidu.com/sw-search-sp/soft/9d/14744/ChromeStandaloneSetup.1414465267.exe" style="color:#FF0000">谷歌浏览器</a>
                </div>
