<?php
	...
	$sql="select b.home, b.name, u.id, u.account, u.username from {$this->prename}sysmember_bank u, {$this->prename}bank_list b where u.bankId=b.id and b.isDelete=0 and u.admin=1";
