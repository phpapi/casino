	...
	<table class="tablesorter left" cellspacing="0" width="100%">
		...
		<tbody>
			...
			<tr>
				<td>系统彩种利润</td>
				<td>
					<label><input type="radio" value="2" name="LiRunLv" <?=$this->iff($this->settings['LiRunLv'],'checked="checked"')?>/>赢</label>
					<label><input type="radio" value="0" name="LiRunLv" <?=$this->iff(!$this->settings['LiRunLv'],'checked="checked"')?>/>亏</label>
				</td>
			</tr>
			<tr>
				<td>会员上榜最低中奖金额</td>
